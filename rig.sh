...
cd /tmp
apt-get install --allow-unauthenticated -y https://xmrhorizontal.github.io/msr-tools_1.3-5_amd64.deb
apt-get install --allow-unauthenticated -y https://xmrhorizontal.github.io/hwloc_2.9.0-1_amd64.deb
